...
namespace _01._Advertisement_Message
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"{phrases[randomPhrase.Next(0, phrases.Count)]} {events[randomPhrase.Next(0, events.Count)]} {authors[randomPhrase.Next(0, authors.Count)]} - {cities[randomPhrase.Next(0, cities.Count)]}");
            }
